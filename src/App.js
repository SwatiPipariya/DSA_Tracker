	...
	return (
		<div className={dark ? "App dark" : "App"}>
			<h1 className="app-heading " style={{ color: dark ? "white" : "" }}>
				...
				{/* <h1 className="text-center float-sm-right my-7"><strong>NRI Group Of Institutions</strong></h1> */}
				<div className="text-center  float-sm-right">Data Structures And Algorithm</div>
				<br />

			</h1>
			{/* <h2 className="text-center">
				This Website is developed by  students of 8th sem from the Department Of Computer Science And Engineering.
			</h2> */}
			{/* <br></br>
			<br></br> */}
