					...
					question: (
						<>
							...
							<span
								// href={question.URL}
								onClick={() => {
									localStorage.setItem('question', question.Problem)
									navigate('/compiler')
				...
				<div className="container">
					<div>
						...
						<div style={{display: "block"}}>
							<h6 style={{fontWeight: "bold", padding: "6px", borderRadius: "5px" ,color: "white", backgroundImage: " linear-gradient(to right, #FF512F 0%, #DD2476  51%, #FF512F  100%"}}>
								Note: Click on the questions given below in order to practise the question with the help of compiler.
							</h6>
							</div>
							<br></br>
					</div>
